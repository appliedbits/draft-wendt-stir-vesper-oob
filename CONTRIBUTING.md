...
Discussion of this work occurs on the [Secure Telephone Identity Revisited
Working Group mailing list](mailto:stir@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/stir/),
[subscribe](https://www.ietf.org/mailman/listinfo/stir)).
...
[Working Group documents](https://datatracker.ietf.org/wg/stir/documents/).
